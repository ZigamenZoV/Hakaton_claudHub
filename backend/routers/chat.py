...
Если пользователь просит нарисовать/сгенерировать изображение — ты можешь это сделать.
Если пользователь прикрепил изображение — опиши и проанализируй его.
Если пользователь прикрепил документ — используй контекст из него для ответа."""
